...
const ScheduleTracker = ({ 
  ...
  const remainingExpectedSeconds = remainingTasks.reduce(
    (sum, task) => sum + (task.duration * 60), 
    0
  );
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className={cn(
          ...
          isBehind && "text-red-600 dark:text-red-500",
      ...
      <div className="relative h-10 bg-muted rounded-lg overflow-hidden">
        <div 
          className={cn(
            ...
            isAhead && "bg-gradient-to-r from-green-400 to-green-600",
            isBehind && "bg-gradient-to-r from-red-400 to-red-600",
            isOnTrack && "bg-gradient-to-r from-blue-400 to-blue-600",
            isPaused && "opacity-60"
          )}
      ...
      <div className={cn(
        ...
        isAhead && "bg-green-50 dark:bg-green-950 border-green-300 dark:border-green-700 text-green-800 dark:text-green-200",
        isBehind && "bg-red-50 dark:bg-red-950 border-red-300 dark:border-red-700 text-red-800 dark:text-red-200",
        isOnTrack && "bg-blue-50 dark:bg-blue-950 border-blue-300 dark:border-blue-700 text-blue-800 dark:text-blue-200"
      )}>
        {getMessage()}
      </div>
      ...
      <div className="flex justify-between text-xs text-muted-foreground">
        ...
        {remainingExpectedSeconds > 0 && (
          <span>Remaining expected: {formatTime(remainingExpectedSeconds)}</span>
        )}
